...
public class AudioControllerEditor : Editor {
	...
	{
		InitData ();
		GameObject audioContainer = AssetDatabase.LoadAssetAtPath<GameObject> ("Assets/Bundles/Audio/AudioContainer.prefab");
        ...
        PrefabUtility.ReplacePrefab(newobj, PrefabUtility.GetCorrespondingObjectFromSource(newobj), ReplacePrefabOptions.Default);
	...
	private static void InitData()
	{
		...
		//初始化音效文件
		string[] pathArr = { "Assets/Bundles/Audio" };
