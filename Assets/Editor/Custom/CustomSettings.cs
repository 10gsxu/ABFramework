...
public static class CustomSettings
{
    ...
    {        
        ...
        _DT(typeof(EventTriggerListener.PointerEventDelegate)),
        _DT(typeof(EventTriggerListener.BaseEventDelegate)),
        _DT(typeof(EventTriggerListener.AxisEventDelegate)),
    ...
    {                
        ...
        _GT(typeof(AudioController)),
        _GT(typeof(AudioCategory)),
        _GT(typeof(AudioObject)),
        _GT(typeof(Sprite)),
        ...
        _GT(typeof(U3DEventFrame.ObjectMsg<float>)),
        _GT(typeof(U3DEventFrame.ObjectMsg<string>)),
        _GT(typeof(U3DEventFrame.StringMsg)),
        _GT(typeof(U3DEventFrame.MsgCenter)),
    };
