...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		AudioControllerWrap.Register(L);
		AudioCategoryWrap.Register(L);
		...
		RegisteredComponentWrap.Register(L);
		...
		U3DEventFrame_ObjectMsg_floatWrap.Register(L);
		U3DEventFrame_ObjectMsg_stringWrap.Register(L);
		U3DEventFrame_StringMsgWrap.Register(L);
		...
		L.EndModule();
		L.BeginModule("AudioObject");
		L.RegFunction("AudioEventDelegate", AudioObject_AudioEventDelegate);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int AudioObject_AudioEventDelegate(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<AudioObject.AudioEventDelegate>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<AudioObject.AudioEventDelegate>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
